...
For this project there are two different potentials that are being used: the Coulomb, and the Woods-Saxon potential. This folder houses the files for the Woods-Saxon potential. Within this folder there are two different folders for two different values of angular momentum: 0 and 1.
